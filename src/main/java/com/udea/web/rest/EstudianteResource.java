        ...
        Optional<Estudiante> result = estudianteRepository
            ...
            .map(existingEstudiante -> {
                if (estudiante.getCedula() != null) {
                    existingEstudiante.setCedula(estudiante.getCedula());
                }
                ...
                if (estudiante.getCorreoInstitucional() != null) {
                    existingEstudiante.setCorreoInstitucional(estudiante.getCorreoInstitucional());
                }
                if (estudiante.getCorreoPersonal() != null) {
                    existingEstudiante.setCorreoPersonal(estudiante.getCorreoPersonal());
                }
                if (estudiante.getCelular() != null) {
                    existingEstudiante.setCelular(estudiante.getCelular());
                }
                if (estudiante.getEstrato() != null) {
                    existingEstudiante.setEstrato(estudiante.getEstrato());
                }
                if (estudiante.getFechaIngreso() != null) {
                    existingEstudiante.setFechaIngreso(estudiante.getFechaIngreso());
                }
                if (estudiante.getVersion() != null) {
                    existingEstudiante.setVersion(estudiante.getVersion());
                }
                if (estudiante.getCodigoPrograma() != null) {
                    existingEstudiante.setCodigoPrograma(estudiante.getCodigoPrograma());
                }
