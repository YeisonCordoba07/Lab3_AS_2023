...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './solicitud-homologacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITUDHOMOLOGACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOLICITUDHOMOLOGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOLICITUDHOMOLOGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOLICITUDHOMOLOGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITUDHOMOLOGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOLICITUDHOMOLOGACION actions', async () => {
      const expectedActions = [
        {
