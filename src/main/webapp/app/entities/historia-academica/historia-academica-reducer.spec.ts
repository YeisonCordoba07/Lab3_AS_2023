...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './historia-academica.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORIAACADEMICA_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORIAACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORIAACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORIAACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORIAACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORIAACADEMICA actions', async () => {
      const expectedActions = [
        {
