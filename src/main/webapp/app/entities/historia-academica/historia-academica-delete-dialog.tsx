...
export const HistoriaAcademicaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyectoh4App.historiaAcademica.delete.question">
        <Translate contentKey="proyectoh4App.historiaAcademica.delete.question" interpolate={{ id: historiaAcademicaEntity.id }}>
