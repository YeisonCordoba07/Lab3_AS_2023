...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTADOSOLICITUD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTADOSOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTADOSOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTADOSOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTADOSOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTADOSOLICITUD actions', async () => {
      const expectedActions = [
        {
