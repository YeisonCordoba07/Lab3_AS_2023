...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIASEMESTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIASEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIASEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIASEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIASEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIASEMESTRE actions', async () => {
      const expectedActions = [
        {
