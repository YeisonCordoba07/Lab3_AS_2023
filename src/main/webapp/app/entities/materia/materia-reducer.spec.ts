...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './materia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIA actions', async () => {
      const expectedActions = [
        {
