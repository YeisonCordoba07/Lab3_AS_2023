...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTADOSEMESTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTADOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTADOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTADOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTADOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTADOSEMESTRE actions', async () => {
      const expectedActions = [
        {
