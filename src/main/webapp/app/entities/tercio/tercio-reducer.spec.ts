...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tercio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERCIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TERCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERCIO actions', async () => {
      const expectedActions = [
        {
