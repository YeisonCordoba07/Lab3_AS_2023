...
export const MateriaSolicitudDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyectoh4App.materiaSolicitud.delete.question">
        <Translate contentKey="proyectoh4App.materiaSolicitud.delete.question" interpolate={{ id: materiaSolicitudEntity.id }}>
