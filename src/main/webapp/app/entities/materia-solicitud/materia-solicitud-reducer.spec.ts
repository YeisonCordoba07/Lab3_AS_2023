...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './materia-solicitud.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIASOLICITUD_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIASOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIASOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIASOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIASOLICITUD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIASOLICITUD actions', async () => {
      const expectedActions = [
        {
