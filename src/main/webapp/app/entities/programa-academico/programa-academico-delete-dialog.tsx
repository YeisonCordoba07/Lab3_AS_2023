...
export const ProgramaAcademicoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyectoh4App.programaAcademico.delete.question">
        <Translate contentKey="proyectoh4App.programaAcademico.delete.question" interpolate={{ id: programaAcademicoEntity.id }}>
