...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOSEMESTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOSEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOSEMESTRE actions', async () => {
      const expectedActions = [
        {
