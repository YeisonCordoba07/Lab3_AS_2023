...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './situacion-academica.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SITUACIONACADEMICA_LIST actions', async () => {
    ...
    it('dispatches FETCH_SITUACIONACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SITUACIONACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SITUACIONACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SITUACIONACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SITUACIONACADEMICA actions', async () => {
      const expectedActions = [
        {
