...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './relacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELACION actions', async () => {
      const expectedActions = [
        {
